...
public class IdentifierInstruction implements Instruction {
	...
	public static Instruction of(LiteralNode node) {
		return new IdentifierInstruction(node.getPosition(), node.getValue().identifierValue());
	}
	...
	@Override
	public RuntimeResult process(InstructionData env) { // TODO
		return new RuntimeResult().value(RuntimeValue.of(getPosition(), value));
	}
